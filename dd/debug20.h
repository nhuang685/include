...
template <class T, class U> std::ostream& operator<<(std::ostream& out, const std::pair<T, U>& p);
template <typename... Types> std::ostream& operator<<(std::ostream& out, const std::tuple<Types...>& value);

template <class T> std::ostream& operator<<(std::ostream& out, const std::vector<T>& v);
template <class T, std::size_t sz> std::ostream& operator<<(std::ostream& out, const std::array<T, sz>& v);

template <class T> std::ostream& operator<<(std::ostream& out, const std::set<T>& v);
template <class T> std::ostream& operator<<(std::ostream& out, const std::unordered_set<T>& v);
template <class T, class U> std::ostream& operator<<(std::ostream& out, const std::map<T, U>& v);
template <class T, class U> std::ostream& operator<<(std::ostream& out, const std::unordered_map<T, U>& v);
template <class T> std::ostream& operator<<(std::ostream& out, const std::multiset<T>& v);
template <class T> std::ostream& operator<<(std::ostream& out, const std::unordered_multiset<T>& v);
template <class T, class U> std::ostream& operator<<(std::ostream& out, const std::multimap<T, U>& v);
...
template <class T, class F> std::ostream& printRange(std::ostream& out, const T& begin, const T& end, const F& proj) {
  out << "{";
  for (auto it = begin; it != end; ++it) {
    out << proj(*it);
    if (std::next(it) != end) {
...
//   std::cerr << '\n';
// }
template <class F, class T> void dbg3(const F& f, const T& t) { std::cerr << f(t) << '\n'; }
...
//   dbg2(args...);
// }
template <class F, class T, class... Args> void dbg3(const F& f, const T& t, const Args&... args) {
  std::cerr << f(t) << ", ";
  dbg3(f, args...);
}
template <class F, class T, class... Args> void dbg4(const F& f, const T& t, const Args&... args) {
  printRange(std::cerr, t.begin(), t.end(), f);
  std::cerr << ", ";
  dbg4(f, args...);
}
